export default {
  ...
  assistancePage: {
    unloadEvent: {
      ...
      description: 'Če se odjavite, bo zahteva za podporo izgubljena.',
    },
    dataValidate: {
    ...
    back: 'Nazaj',
    forward: 'Naprej',
    linkPrivacyPolicy: 'Z nadaljevanjem izjavljate, da ste prebrali <1>Pravilnik o varovanju zasebnosti pri podpori</1>',
  },
};
